...
export class SeasonsCardComponent {
  ...
  season2: IUseason = {
    nombre: 'Temporada 2',
    descripcion: `En la segunda temporada de Good Omens, la relación entre Aziraphale y Crowley se profundiza mientras continúan viviendo entre los humanos tras haber evitado el Apocalipsis. Ahora que el Armagedón ha sido cancelado (al menos por el momento), ambos disfrutan de la vida en la Tierra, pero las fuerzas celestiales e infernales siguen observando.
